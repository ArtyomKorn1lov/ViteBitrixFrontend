...
class TopicIBlock20260423174322 extends Version
{
    protected $author = "admin";

    protected $description = "ИБ - темы для обсуждения";
    ...
    public function up()
    {
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'LIST_TYPE' => 'L',
            'MULTIPLE' => 'Y',
            'XML_ID' => 'd2d09ea3-3bd9-4197-802c-a6570b830b5c',
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'LIST_TYPE' => 'L',
            'MULTIPLE' => 'N',
            'XML_ID' => '6f04637d-ba22-4a04-a8e0-38b84633bcf6',
            'FILE_TYPE' => '',
            'MULTIPLE_CNT' => '5',
            'LINK_IBLOCK_ID' => '0',
            'WITH_DESCRIPTION' => 'N',
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'LIST_TYPE' => 'L',
            'MULTIPLE' => 'Y',
            'XML_ID' => '518508f7-3da5-4255-ba5f-5549cf1f2db0',
            'FILE_TYPE' => '',
            'MULTIPLE_CNT' => '5',
            'LINK_IBLOCK_ID' => '0',
            'WITH_DESCRIPTION' => 'N',
        ...
        $helper->UserOptions()->saveElementForm($iblockId, array(
            'Параметры|edit1' =>
                array(
                    ...
                    'SORT' => 'Сортировка',
                    'PROPERTY_TAGS' => 'Теги',
                    'PROPERTY_AUTHOR' => 'Автор темы',
                    'PROPERTY_PICTURES' => 'Изображения',
