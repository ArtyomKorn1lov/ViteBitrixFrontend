...
export const showNotification = ({ title = t('core.messages.errorTitle'), message = '', type = ResponseStatus.error }: NotificationProps): void => {
  ElNotification({
    title: title,
    message: message,
    type: type,
...
}: ConfirmMessageBoxProps): Promise<void> => {
